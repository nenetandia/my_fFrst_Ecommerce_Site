...
function vw_storefront_admin_theme_style() {
   wp_enqueue_style( 'vw-storefront-font', vw_storefront_admin_font_url(), array() );
...
// Theme Font URL
function vw_storefront_admin_font_url() {
	$font_url = '';
	$font_family = array();
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_storefront_open_tab(event, 'storefront_lite')"><?php esc_html_e( 'Getting Started', 'vw-storefront' ); ?></button>		  
		...
		<!-- Tab content -->
		<div id="storefront_lite" class="tabcontent open">
				...
				<div class="info-link">
		  		...
		  		<div class="link-customizer">
					...
					<div class="first-row">
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-format-image"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[control]=custom_logo') ); ?>" target="_blank"><?php esc_html_e('Upload your logo','vw-storefront'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_storefront_slidersettings') ); ?>" target="_blank"><?php esc_html_e('Slider Settings','vw-storefront'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
							...
							<div class="row-box2">
								<span class="dashicons dashicons-editor-table"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_storefront_product_section') ); ?>" target="_blank"><?php esc_html_e('Featured Product','vw-storefront'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-editor-aligncenter"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=nav_menus') ); ?>" target="_blank"><?php esc_html_e('Menus','vw-storefront'); ?></a>
							</div>
							<div class="row-box2">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_storefront_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','vw-storefront'); ?></a>
							</div>
							 <div class="row-box2">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_storefront_social_icon_settings') ); ?>" target="_blank"><?php esc_html_e('Social Icons Settings','vw-storefront'); ?></a>
							</div> 
						</div>
						
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_storefront_left_right') ); ?>" target="_blank"><?php esc_html_e('General Settings','vw-storefront'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_storefront_footer') ); ?>" target="_blank"><?php esc_html_e('Footer Text','vw-storefront'); ?></a>
							</div>
						</div>
					</div>
				</div>
