...
function vw_storefront_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_storefront_email_address',array(
		'default'=> '',
		'sanitize_callback'	=> 'vw_storefront_sanitize_email'
	));	
	...
	$wp_customize->add_setting( 'vw_storefront_metabox_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_storefront_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Storefront_Toggle_Switch_Custom_Control( $wp_customize, 'vw_storefront_metabox_hide_show',array(
      'label' => esc_html__( 'Show / Hide Metabox','vw-storefront' ),
      'section' => 'vw_storefront_responsive_media'
    )));
	...
	$wp_customize->add_control(new VW_Storefront_Toggle_Switch_Custom_Control(
