<?php
/**
 * VW Storefront Theme: Block Patterns
 *
...
if ( function_exists( 'register_block_pattern' ) ) {
	...
	register_block_pattern(
		...
		array(
			'title'      => __( 'VW Storefront Featured Product Section', 'vw-storefront' ),
			'categories' => array( 'vw-storefront' ),
