<?php
    ...
    if($sirat_resp_scroll_top == true){
		...
		$sirat_custom_css .='a.scrollup{';
			$sirat_custom_css .='visibility:visible;';
		$sirat_custom_css .='} }';
	...
	$sirat_resp_preloader = get_theme_mod( 'sirat_resp_preloader_hide_show',true);
    if($sirat_resp_preloader == true){
    	$sirat_custom_css .='@media screen and (max-width:575px) {';
		$sirat_custom_css .='#preloader{';
			$sirat_custom_css .='display:block;';
		$sirat_custom_css .='} }';
	}else if($sirat_resp_preloader == false){
		$sirat_custom_css .='@media screen and (max-width:575px) {';
		$sirat_custom_css .='#preloader{';
			$sirat_custom_css .='display:none;';
		$sirat_custom_css .='} }';
