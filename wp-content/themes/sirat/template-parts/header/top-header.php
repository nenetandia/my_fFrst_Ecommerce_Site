			...
			<div class="row">
				<div class="col-lg-3 col-md-3">
				    <?php if( get_theme_mod( 'sirat_contact_call') != '') { ?>
	          			<a href="tel:<?php echo esc_url( get_theme_mod('sirat_contact_call','') ); ?>"><p><i class="<?php echo esc_attr(get_theme_mod('sirat_phone_icon','fas fa-phone')); ?>"></i><?php echo esc_html(get_theme_mod('sirat_contact_call',''));?></p></a>
	    			<?php } ?>
			    </div>
			    <div class="col-lg-4 col-md-4">
				    <?php if( get_theme_mod( 'sirat_contact_email') != '') { ?>
	          			<a href="mailto:<?php echo esc_url( get_theme_mod('sirat_contact_email','') ); ?>"><p><i class="<?php echo esc_attr(get_theme_mod('sirat_contact_email_icon','far fa-envelope')); ?>"></i><?php echo esc_html(get_theme_mod('sirat_contact_email',''));?></p></a>
	        		<?php }?>
			    </div>
