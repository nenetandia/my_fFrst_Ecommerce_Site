...
<div class="menubar">
	<?php if(has_nav_menu('primary')){ ?>
		<div class="toggle-nav mobile-menu">
		    <button onclick="sirat_menu_open_nav()" class="responsivetoggle"><i class="<?php echo esc_attr(get_theme_mod('sirat_res_menus_open_icon','fas fa-bars')); ?>"></i><?php echo esc_html( get_theme_mod('sirat_mobile_menu_label', __('Menu','sirat'))); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('sirat_mobile_menu_label', __('Menu','sirat'))); ?></span></button>
		</div>
	<?php } ?>
