        ...
        <?php if( get_theme_mod( 'sirat_single_post_postdate',true) != '' || get_theme_mod( 'sirat_single_post_author',true) != '' || get_theme_mod( 'sirat_single_post_comments',true) != '' || get_theme_mod( 'sirat_single_post_time',true) != '') { ?>
            <div class="post-info">
                <?php if(get_theme_mod('sirat_single_post_postdate',true)==1){ ?>
                    <span class="entry-date"><i class="<?php echo esc_attr(get_theme_mod('sirat_single_post_postdate_icon','fas fa-calendar-alt')); ?>"></i><a href="<?php echo esc_url( get_day_link( $sirat_archive_year, $sirat_archive_month, $sirat_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span><?php echo esc_html(get_theme_mod('sirat_single_post_meta_field_separator','|'));?></span>
                <?php } ?>

                <?php if(get_theme_mod('sirat_single_post_author',true)==1){ ?>
                    <span class="entry-author"><i class="<?php echo esc_attr(get_theme_mod('sirat_single_post_author_icon','far fa-user')); ?>"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><span><?php echo esc_html(get_theme_mod('sirat_single_post_meta_field_separator','|'));?></span>
                <?php } ?>

                <?php if(get_theme_mod('sirat_single_post_comments',true)==1){ ?>
                    <span class="entry-comments"><i class="<?php echo esc_attr(get_theme_mod('sirat_single_post_comments_icon','fas fa-comments')); ?>"></i><?php comments_number( __('0 Comment', 'sirat'), __('0 Comments', 'sirat'), __('% Comments', 'sirat') ); ?> </span><span><?php echo esc_html(get_theme_mod('sirat_single_post_meta_field_separator','|'));?></span>
                <?php } ?>
